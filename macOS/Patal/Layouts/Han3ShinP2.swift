...
struct Han3ShinP2Layout: HangulAutomata {
    let availableTraits: Set<LayoutTrait> = [LayoutTrait.아래아, LayoutTrait.글자단위삭제, LayoutTrait.수정기호, LayoutTrait.빠른마침표, LayoutTrait.옵션라틴, LayoutTrait.기호확장, LayoutTrait.ESC라틴]
